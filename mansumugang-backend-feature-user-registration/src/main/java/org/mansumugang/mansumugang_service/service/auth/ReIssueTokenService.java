...
public class ReIssueTokenService {
    ...
    public ReissueTokenDto reissueToken(String accessToken, String refreshToken){
        ...
        String savedAccessToken = valueOperations.get(resolvedAccessToken);
        ...
        boolean isRefreshTokenExpired = jwtTokenProvider.isTokenExpired(TokenType.REFRESH_TOKEN,savedAccessToken);
